...
function AboutMe() {
  return (
    <>
      ...
      <GroovyArticle>
        Check out <Link to="/">my transcriptions</Link> where I am adding songs
        I am learning by ear, these may not be perfect! Over the years I have
        struggled a bit with <Link to="/improvisation">improvisation</Link> so I
        have shared how I improvise. I have a lot of pedals - some info in the{" "}
        ...
        learn more <Link to="/bass_theory">theory</Link>. A practice{" "}
