export const cubaseTips = [
  {
    topic: "Tools (Remove 1 done)",
    tips: [
      { tip: "Numbers equate to the tools 1-9" },
      {
        tip: "Snap on or off, default is Bar, also can be set to Grid, Beat, Quantize",
      },
      {
  ...
  {
    topic: "Editing Audio (Remove 4 done)",
    tips: [
      {
  ...
  {
    topic: "Mixing (Remove 6 incomplete)",
    tips: [
      {
  ...
  {
    topic: "Inserts, Sends, FX Channels (Remove 7 incomplete)",
    tips: [
      {
